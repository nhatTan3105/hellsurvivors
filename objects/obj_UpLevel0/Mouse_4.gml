...
//Slash upgrade
if(obj_UpLevel0.sprite_index == ss_upgrade_slash){
...
//Shield upgrade
else if(obj_UpLevel0.sprite_index == ss_upgrade_shield){
...
//lightbolt
else if(obj_UpLevel0.sprite_index == ss_upgrade_lightbolt){
...
//fireball
else if(obj_UpLevel0.sprite_index == ss_upgrade_fireball){
