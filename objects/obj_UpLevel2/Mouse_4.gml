...
//Slash upgrade
if(obj_UpLevel2.sprite_index == ss_upgrade_slash){
...
//Shield upgrade
else if(obj_UpLevel2.sprite_index == ss_upgrade_shield){
...
//Fireshoot upgrade
else if(obj_UpLevel2.sprite_index == ss_upgrade_fireshoot){
...
//lightbolt
else if(obj_UpLevel2.sprite_index == ss_upgrade_lightbolt){
...
//blackhole
else if(obj_UpLevel2.sprite_index == ss_upgrade_blackhole){
	if(global.alarm_blackhole== -1){
		...
		//-30% countdown
		global.alarm_blackhole -= global.alarm_blackhole*0.1;
		//+30% dmg
...
//fireball
else if(obj_UpLevel2.sprite_index == ss_upgrade_fireball){
